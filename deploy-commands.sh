...
print_info "💡 TIP: After successful deployment, you can reset to default with:"
print_command "git config --global --unset http.postBuffer"
...
echo "   - To reset git buffer after deployment: git config --global --unset http.postBuffer"
echo ""
